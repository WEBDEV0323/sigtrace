...
class SignalCalendar extends AbstractActionController
{
    ...
    public function getSignalCalendarFilters($trackerId, $formId, $typeOfFilter = '')
    {
        $arr = array();
        try {
    ...
    public function getSignalCalendarQueries($trackerId, $formId, $typeOfReport = '')
    {
        $arr = array();
        try {
            $sql = new Sql($this->_adapter);
    ...
    public function getSignalCalendarCountReports($trackerId, $formId)
    {
        $sql = new Sql($this->_adapter);
        $select = $sql->select();
