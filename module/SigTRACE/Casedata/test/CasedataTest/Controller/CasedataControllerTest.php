...
namespace SigTRACE\CasedataTest\Controller;

use CasedataTest\Bootstrap;
use Zend\Mvc\Router\Http\TreeRouteStack as HttpRouter;
use SigTRACE\Casedata\Controller\IndexController;
...
class CasedataControllerTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('SigTRACE\Casedata\Model\Casedata', $this->controller->getCasedataService());
    }

    public function testGetServiceReturnsAnInstanceOfCasedataService()
    {
        $this->assertInstanceOf('SigTRACE\Casedata\Service\CasedataService', $this->controller->getService());
    }

    public function testGetServiceReturnsAnInstanceOfCasdataeHelper()
    {
        $this->assertInstanceOf('SigTRACE\Casedata\Helper\CasedataHelper', $this->controller->getCasedataHelperService());
    }
