    ...
    public function getServiceConfig()
    {
        return array(
            'factories' => array(
                ...
                'Dashboard\Model\Dashboard' => function ($sm) {
                    return new Model\Dashboard($sm->get('trace'));
                },
                'Audit\Model\Audit' => function ($sm) {
                    return new Audit\Model\Audit($sm->get('trace'));
                },
                // 'Tracker\Model\TrackerModule' => function ($sm) {
                //     return new \ASRTRACE\Tracker\Model\TrackerModule($sm->get('trace'));
                // },
                'Dashboard\Model\Db' => function ($sm) {
