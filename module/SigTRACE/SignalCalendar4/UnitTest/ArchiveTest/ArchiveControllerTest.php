...
namespace RITRACE\ArchiveTest\Controller;

use RITRACE\ArchiveTest\Bootstrap;
use Zend\Mvc\Router\Http\TreeRouteStack as HttpRouter;
use RITRACE\Archive\Controller\ArchiveController;
...
class ArchiveControllerTest extends TestCase
{
    ...
    { 
        ...
        $this->routeMatch       =   new RouteMatch(array('controller' => 'Archive'));
