    ...
    public function getServiceConfig()
    {
        return array(
            'factories' => array(
                ...
                'Common\Workflow\Service' => function ($sm) {
                    return new \Common\Workflow\Model\Workflow($sm->get('trace'));
                },
                'Common\Role\Service' => function ($sm) {
                ...
                'Trigger\Service' => function ($sm) {
                    return new \Common\Trigger\Model\Trigger($sm->get('trace'));
                }
            ),
        );
    }
