<?php
namespace SignalCalendar\Controller;
...
class ImportController extends AbstractActionController
{
    ...
    public function getImportService()
    {
        if (!$this->_adminMapper) {
            ...
            $this->_adminMapper = $sm->get('SignalCalendar\Model\Import');
        }
    ...
    public function getService()
    {
        if (!$this->_serviceMapper) {
            $sm = $this->getServiceLocator();
            $this->_serviceMapper = $sm->get('SignalCalendar\Service\ImportService');
        }
