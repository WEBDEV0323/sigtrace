        ...
        try {
            ...
            if ($trackerId != 0 && $formName != "" && $record != "") {
                ...
                if ($count > 0) {
                    ...
                    $query = "CREATE TABLE form_".$trackerId."_".$formId." (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, created_by INT(6), last_updated_by INT(6), `created_date_time` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, `is_deleted` ENUM('Yes','No') NOT NULL DEFAULT 'No') collate utf8_general_ci";
