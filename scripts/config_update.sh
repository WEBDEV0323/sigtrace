...
#
sed -i -e "s/{{RDSENDPOINT}}/$RDSENDPOINT/g" ../config/autoload/global.php
sed -i -e "s/{{RDSDBNAME}}/$RDSDBNAME/g" ../config/autoload/global.php
sed -i -e "s/{{RDSUSERNAME}}/$RDSUSERNAME/g" ../config/autoload/global.php
sed -i -e "s/{{RDSSECRET}}/$RDSSECRET/g" ../config/autoload/global.php
...
#
# Edit File for SigTraceLog.conf
#
...
sed -i -e "s/{{RDSENDPOINT}}/$RDSENDPOINT/g" ../conf/logstash/siglog.conf
sed -i -e "s/{{RDSUSERNAME}}/$RDSUSERNAME/g" ../conf/logstash/siglog.conf
sed -i -e "s/{{RDSSECRET}}/$RDSSECRET/g" ../conf/logstash/siglog.conf

sed -i -e "s/{{BUILDNUMBER}}/$BUILD_BUILDNUMBER/g" ../module/Application/view/layout/footer.phtml
#
