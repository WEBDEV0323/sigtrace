/* jshint shadow:true */
/*jshint sub:true*/
function textFields(fieldLabel,fieldName,fieldType,value,readonly,validation){
   var html="";
   html+= '<div class="col-6 row">';  
...
function readOnlyFields(fieldLabel,fieldName,value){
   var html="";
   html+= '<div class="col-6 row">';
...
function textAreaFields(fieldLabel,fieldName,value,readonly, validation){
   var html="";
   html+= '<div class="col-6 row">';
   html+= '<label for="'+fieldName+'" class="col-sm-4 col-form-label '+validation+'" style="margin-top: 10px;">'+fieldLabel+'</label>';
   html+= '<div class="col-sm-7" style="margin-top: 10px;">';
...
function dropDownSingleSelectFields(fieldLabel,fieldName,options,value,disabled,validation){
   var html="";
   html+= '<div class="col-6 row">';
...
function userRoleFields(fieldLabel,fieldName,options,value,disabled,validation){
   var html="";
   html+= '<div class="col-6 row">';
   html+= '<label for="'+fieldName+'" class="col-sm-4 col-form-label '+validation+'">'+fieldLabel+'</label>';
   html+= '<div class="col-sm-7" style="margin-top: 10px;">';
...
function currentUserFields(fieldLabel,fieldName,value){
   var html="";
   html+= '<div class="col-6 row">';
   html+= '<label for="'+fieldName+'" class="col-sm-4 col-form-label" style="margin-top: 10px;">'+fieldLabel+'</label>';
   html+= '<div class="col-sm-7" style="margin-top: 15px;">';
...
function integerFields(fieldLabel,fieldName,value,readonly,validation){
    var html="";
    html+= '<div class="col-6 row">';
    html+= '<label for="'+fieldName+'" class="col-sm-4 col-form-label '+validation+'" style="margin-top: 10px;">'+fieldLabel+'</label>';
    html+= '<div class="col-sm-7" style="margin-top: 10px;">';
...
function dateTypeFields(fieldLabel,fieldName,fieldType,value,dateFormat,validation){
...
function dateTimeTypeFields(fieldLabel,fieldName,fieldType,value,dateTimeFormat,validation){
    var html="";
    html+= '<div class="col-6 row">';
    html+= '<label for="" class="col-sm-4 col-form-label '+validation+'" style="margin-top: 10px;">'+fieldLabel+'</label>';
    html+= '<div class="col-sm-7" style="margin-top: 10px;">';
...
function checkBoxFields(fieldLabel,fieldName,options,valueArr,textAreaValue,disabled,validation){ 
   var html="";
   html+= '<div class="col-6 row">';
   html+= '<div class="col-sm-4 col-form-label '+validation+'" style="margin-top: 10px;">'+fieldLabel+'</div>';
   ...
   for(var k in options) {
      ...
      if (valueArr.includes(options[k]['optionValue'])) {
         checkedStatus=1;
...
function formulaFields(fieldLabel,fieldName,fieldType,value,formula,formula_dep){
   var html="";
   html+= '<div class="col-6 row">';
   html+= '<label for="'+fieldName+'" class="col-sm-4 col-form-label" style="margin-top: 10px;">'+fieldLabel+'</label>';
   html+= '<div class="col-sm-7" style="margin-top: 10px;">';
...
function formulaeDropDownFields(fieldLabel,fieldName,options,value,formula,formula_dep){
   var html="";
   html+= '<div class="col-6 row">';
...
function formulaDateFields(fieldLabel,fieldName,fieldType,value,formula,formula_dep,dateFormat){
   var html="";
   html+= '<div class="col-6 row">';
   html+= '<label for="'+fieldName+'" class="col-sm-4 col-form-label" style="margin-top: 10px;">'+fieldLabel+'</label>';
   html+= '<div class="col-sm-7" style="margin-top: 10px;">';
...
function fileFields(fieldLabel,fieldName,value,validation){
   var html="";
   html+= '<div class="col-6 row">';
   ...
   if (value!='') {
      ...
      html+= '<a href="/aws/downloadFilesFromAws/'+keyname+'/'+btoa(value)+'" class="stretched-link" title="'+value+'">Download attachment</a>';
...
function dependentTextFields(fieldLabel,fieldName,value,formula,formula_dep){
   var html="";
   html+= '<div class="col-6 row">';
   html+= '<label for="'+fieldName+'" class="col-sm-4 col-form-label" style="margin-top: 10px;">'+fieldLabel+'</label>';
   html+= '<div class="col-sm-7" style="margin-top: 10px;">';
...
function fileFieldsDownload(fieldLabel,fieldName,value){
   var html="";
   html+= '<div class="col-6 row">';
   html+= '<label for="'+fieldName+'" class="col-sm-4 col-form-label" style="margin-top: 10px;">'+fieldLabel+'</label>';
   html+= '<div class="col-sm-7" style="margin-top: 15px;">';
...
function hiddenFormulaFields(fieldName,formula,formula_dep){
   var html="";
   html+= '<input type="hidden" class="form-control formula" id="'+fieldName+'" value="" name="'+fieldName+'" formula="'+formula+'" formula_dep="'+formula_dep+'">';
   return html;
}
