...
function editFieldName(value)
{
    ...
    var default_value = value["defaultValue"];
    sel_rule_id = rule_id;
    ...
    $("#edit_default_value").val(default_value);
    ...
    if(fieldType == 'Integer' || fieldType == 'Text' || fieldType == 'TextArea'  || fieldType == 'ReadOnly'){
        $("#default_value_id_display_edit").css("visibility", "visible");
    } else {
        $("#default_value_id_display_edit").css("visibility", "hidden");
    }
...
function addFieldName() {
   ...
   var default_value = '';
   if(fieldType == 'Integer' || fieldType == 'Text' || fieldType == 'TextArea'  || fieldType == 'ReadOnly'){
    default_value = $.trim($("#add_default_value").val());
   }
...
function editFieldList()
{
   ...
   var default_value = '';
   if(fieldType == 'Integer' || fieldType == 'Text' || fieldType == 'TextArea'  || fieldType == 'ReadOnly'){
    default_value = $.trim($("#edit_default_value").val());
   }
...
function checkMultiple(id, selID, start, questionType){
    ...
    if(selVal == 'Integer' || selVal == 'Text' || selVal == 'TextArea'  || selVal == 'ReadOnly'){
        if (questionType == 'add_field_type') {
            $("#default_value_id_display_add").css("visibility", "visible");
        } else {
            $("#default_value_id_display_edit").css("visibility", "visible");
        }         
    } else {
        if (questionType == 'add_field_type') {
            $("#default_value_id_display_add").css("visibility", "hidden");  
        } else {
            $("#default_value_id_display_edit").css("visibility", "hidden");
        }
    }
