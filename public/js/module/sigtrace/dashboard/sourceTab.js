...
$(function () {
  ...
  $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) { 
    ...
    if(activatedTab!='moleculesourceList') {
...
function renderCallbackGrids(response) { 
    for(var i in response.data) {  
        ...
        productGrid+= '<a href="#/dashboard/caselist/'+trackerId+'/'+response.data[i]['formId']+'/'+response.data[i]['tabId']+'/'+response.data[i]['as_id']+'" >';
...
$(function() {
  ...
  $('#filterButton').on('click',function(e){
    ...
    window.location.href = '/dashboard/activesubstance/'+trackerId+'/'+formId+'?filter='+filter;
  });
});
...
function gridClick() {
  $('.gridTab').on('click',function(e){
    ...
    var source=$(this).attr('soruce');
    if (atab=='moleculesourceList') { 
      var fieldData = JSON.stringify($('#filterForm').serializeArray());
      var filter = encodeURIComponent(window.btoa(fieldData));
      ...
      //window.location.href = '/dashboard/source/'+trackerId+'/'+formId+'?tabId='+tabId+'&asId='+asId+'&filter='+filter;
      window.location.href = '/dashboard/list/'+trackerId+'/'+formId+'/'+tabId+'/'+asId+'?source='+source+'&'+'filter='+filter;
    }  else if (source == 'Aggregate Reports') {
      var filter=$(this).attr('filter');
      //window.location.href = '/dashboard/source/'+trackerId+'/'+formId+'?tabId='+tabId+'&asId='+asId+'&filter='+filter;
      window.location.href = '/dashboard/list/'+trackerId+'/'+formId+'/'+tabId+'/'+asId+'?source='+source+'&'+'filter='+filter;
    }  else if (source == 'Risk Management Plans') {
      var filter=$(this).attr('filter');
      //window.location.href = '/dashboard/source/'+trackerId+'/'+formId+'?tabId='+tabId+'&asId='+asId+'&filter='+filter;
      window.location.href = '/dashboard/list/'+trackerId+'/'+formId+'/'+tabId+'/'+asId+'?source='+source+'&'+'filter='+filter;
    } else if (source == 'Regulatory Recommendations') {
      var filter=$(this).attr('filter');
      //window.location.href = '/dashboard/source/'+trackerId+'/'+formId+'?tabId='+tabId+'&asId='+asId+'&filter='+filter;
      window.location.href = '/dashboard/list/'+trackerId+'/'+formId+'/'+tabId+'/'+asId+'?source='+source+'&'+'filter='+filter;
    } else if (source == 'Clinical Trial') {
      var filter=$(this).attr('filter');
      //window.location.href = '/dashboard/source/'+trackerId+'/'+formId+'?tabId='+tabId+'&asId='+asId+'&filter='+filter;
      window.location.href = '/dashboard/list/'+trackerId+'/'+formId+'/'+tabId+'/'+asId+'?source='+source+'&'+'filter='+filter;
      ...
      var filter = encodeURIComponent(window.btoa(fieldData));
      window.location.href = '/dashboard/caselist/'+trackerId+'/'+formId+'/'+tabId+'/'+asId+'?filter='+filter;
    }
  });
}
